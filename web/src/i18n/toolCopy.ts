...
export const toolCopy: Record<"png" | "jpg", Record<"en" | "tr", ToolCopy>> = {
  ...
  jpg: {
    ...
    tr: {
      ...
      h1: "PDF'ten JPG'ye",
      tagline:
        "PDF sayfalarını hafif ve paylaşımı kolay JPG görsellerine dönüştürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const splitCopy: Record<"en" | "tr", ToolCopy> = {
  ...
  tr: {
    ...
    h1: "PDF Böl",
    tagline: "Büyük PDF belgelerinizi parçalara ayırın veya içinden sadece istediğiniz sayfaları anında çıkarın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const organizeCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Organize PDF",
    tagline: "Take full control of your document. Drag and drop to rearrange pages, rotate them, or delete the ones you don't need — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Düzenle",
    tagline: "Belgenizin tam kontrolünü elinize alın. Sayfaları sürükleyerek yerlerini değiştirin, döndürün veya istemediğiniz sayfaları kolayca çöpe atın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const reverseCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Flip your document backwards in a single click. Ideal for reversing documents scanned from back-to-front — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Sondan başa taranmış veya sırası karışmış PDF belgelerini tek tıkla tersine çevirin. Sayfa kalitesi %100 korunur — ücretsiz, sınırsız ve tamamen gizli.",
...
export const batesCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Bates Numbering",
    tagline: "Stamp your legal documents with standardized Bates numbers, prefixes, and page digits for court exhibits and evidence — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Hukuk büroları ve adli süreçler için standart Bates önekleri (Örn: DELİL-0001) ile belgelerinizi resmi olarak indeksleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const nupCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "N-Up PDF",
    tagline: "Fit 2, 4, 6, or 9 pages onto a single sheet of paper. Create handout summaries and save printing costs easily — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Bir kağıt üzerine 2, 4 veya daha fazla sayfayı yan yana dizin. Sunum notları, ders slaytları ve kağıt tasarrufu için idealdir — ücretsiz, sınırsız ve tamamen gizli.",
...
export const pdfaCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "PDF to PDF/A",
    tagline: "Transform your documents into ISO-standard PDF/A format for official government submissions, court archives, and lifetime storage — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgelerinizi ISO standartlarında PDF/A arşiv formatına dönüştürün. Resmi kurumlara ve UYAP/E-Devlet sistemlerine sorunsuz yükleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const sanitizeCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Sanitize PDF",
    tagline: "Wipe hidden author details, creation dates, camera GPS tags, and embedded software traces from your PDF documents — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgenizin arkasında gizlenen yazar adını, bilgisayar bilgilerini ve oluşturma geçmişini tek tıkla silerek tam gizlilik sağlayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const watermarkCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Watermark PDF",
    tagline: "Stamp your documents with custom text, copyright notices, or confidentiality markers. Fast, customizable, and — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgelerinize 'GİZLİDİR', şirket adı, telif veya özel yazı damgaları ekleyerek izinsiz kullanımı engelleyin. Verileriniz cihazınızda kalır — ücretsiz, sınırsız ve tamamen gizli.",
...
export const numberCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Add Page Numbers",
    tagline: "Number your PDF pages with clean, customizable formatting. Choose positions, numbering styles, and margins easily — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Raporlarınıza, tezlerinize veya sözleşmelerinize profesyonel sayfa numaraları ekleyin. Alt-orta, sağ-üst gibi tüm konumları destekler — ücretsiz, sınırsız ve tamamen gizli.",
...
export const protectCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Protect PDF",
    tagline: "Keep your sensitive documents safe by locking them with a highly secure, unbreakable password — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Şifrele",
    tagline: "Hassas ve gizli belgelerinizi kırılamaz bir şifre ile kilitleyerek yetkisiz kişilerin açmasını engelleyin. Tamamen güvenli ve yerel — ücretsiz, sınırsız ve tamamen gizli.",
...
export const unlockCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Unlock PDF",
    tagline: "Easily remove passwords and security restrictions from your PDF documents — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Şifre Kırma",
    tagline: "Şifresini bildiğiniz kilitli PDF dosyalarından parola korumasını tamamen silin. İşlemleriniz %100 gizlilikle, sadece cihazınızda gerçekleşir — ücretsiz, sınırsız ve tamamen gizli.",
...
export const rotateCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Rotate PDF",
    tagline: "Easily rotate specific pages or your entire document. Turn upside-down pages right-side up permanently — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Döndürme",
    tagline: "Ters taranmış veya yan duran sayfalarınızı tek tıkla düzeltin. Değişiklikler belgenize kalıcı olarak işlenir — ücretsiz, sınırsız ve tamamen gizli.",
...
export const removeCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Remove Pages",
    tagline:
      "Strip unwanted pages from your PDF cleanly — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Sayfa Sil",
    tagline:
      "İstenmeyen sayfaları PDF belgenizden temizleyin — ücretsiz, sınırsız ve tarayıcınızda — ücretsiz, sınırsız ve tamamen gizli.",
...
export const imgToPdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "JPG to PDF",
    tagline: "Combine multiple photos and images into one clean PDF document. Adjust orientation, margins, and order visually — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Birden fazla fotoğrafı veya taranmış evrak görselini tek bir düzenli PDF belgesi haline getirin. Sayfa sırasını ve yönünü kolayca ayarlayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const flattenCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Flatten PDF",
    tagline: "Lock form fields, signatures, and annotations into the document background so they can never be modified or removed — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Düzleştir",
    tagline: "Form alanlarını, dijital imzaları ve ek açıklamaları kalıcı hale getirin. Belgenizin başkaları tarafından değiştirilmesini engelleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const signCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Sign PDF",
    tagline: "Add your electronic signature to agreements, contracts, and forms — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF İmzala",
    tagline: "Dilekçe, sözleşme ve formlarınıza kolayca e-imza ekleyin. Çıktı alıp tarama derdine son. İmzanız cihazınızdan asla dışarı çıkmaz — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractImagesCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Extract Images",
    tagline: "Pull out all embedded photos, diagrams, and illustrations from your PDF documents in their original crisp resolution — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgenizin içindeki fotoğrafları, grafik ve şekilleri orijinal çözünürlüklerini hiç bozmadan tek tıkla dışa aktarın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const compressCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Compress PDF",
    tagline: "Reduce the file size of your PDF documents drastically while keeping the original layout and quality intact — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Küçült",
    tagline: "E-postaya veya WhatsApp'a sığmayan büyük PDF dosyalarınızı saniyeler içinde sıkıştırın. Metin kalitesi asla bozulmaz — ücretsiz, sınırsız ve tamamen gizli.",
...
export const redactCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Redact PDF",
    tagline: "Black out private information, credit card numbers, or confidential terms permanently — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Hassas kişisel verileri, isimleri ve gizli rakamları kalıcı olarak karartın. Altındaki metinler tamamen kazınır, kopyalanamaz — ücretsiz, sınırsız ve tamamen gizli.",
...
export const repairCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Repair PDF",
    tagline: "Fix broken cross-reference tables, structural errors, and salvage readable pages from corrupted PDF documents — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Açılırken hata veren veya yapısı bozulan PDF belgelerinin iç indeksini yeniden inşa ederek okunabilir hale getirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const grayscaleCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Grayscale PDF",
    tagline: "Turn vibrant color documents into crisp black and white PDFs. Perfect for saving colored printer ink and creating official copies — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Renkli belgeleri, kitapları ve grafikleri net gri tonlamalı (siyah-beyaz) PDF'e dönüştürün. Yazıcı kartuşundan tasarruf edin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const resizeCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Resize PDF",
    tagline: "Change the physical paper size of your PDF pages. Scale documents to A4, US Letter, A3, or custom dimensions — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Boyutlandır",
    tagline: "Belgelerinizin kağıt boyutunu standart A4, A3, US Letter veya özel ölçülere ölçekleyin. Yazdırma sorunlarına son verin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const scanCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Scan to PDF",
    tagline: "Turn your device camera or webcam into a portable document scanner. Capture, enhance contrast, and export clean PDFs — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Telefon veya bilgisayar kameranızı taşınabilir bir tarayıcıya dönüştürün. Sözleşme, fiş ve kimlikleri anında PDF yapın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const bookletCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Booklet PDF",
    tagline: "Reorder and paginate pages into a foldable booklet format. Print double-sided, fold down the center, and create your book — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Sayfalarınızı ortadan katlandığında kitap gibi okunacak şekilde dizin. Çift taraflı yazdırın, ortadan katlayın ve zımbalayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const compareCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Compare PDF",
    tagline: "Easily compare two PDF documents side-by-side. Highlight added, modified, or deleted text between contract revisions — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "İki PDF belgesini yan yana koyup eklenen, silinen ve değiştirilen tüm yazıları renkli olarak anında tespit edin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const cropCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Crop PDF",
    tagline: "Trim wide margins, remove unwanted headers or footers, and crop your PDF pages to the exact visible area — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Kırp",
    tagline: "Geniş kenar boşluklarını, gereksiz alt/üst bilgileri kırpın ve PDF sayfalarınızı tam metne göre hizalayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const ocrCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "OCR PDF",
    tagline: "Turn unselectable text in scanned images and documents into fully searchable and copyable text formats — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Taranmış PDF'ler veya fotoğrafların içindeki seçilemeyen (kopyalanamayan) yazıları tarayıp seçilebilir, kopyalanabilir metinlere dönüştürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const removeBlankCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Scan through multi-page documents to automatically detect and discard accidental blank pages from scanners — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Çift taraflı taramalardan kaynaklanan boş, beyaz sayfaları akıllı analizle tek tıkla bulun ve belgenizden ayıklayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const editMetadataCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Edit Metadata",
    tagline: "Update document titles, author names, subject tags, and keywords. Fix PDF document properties cleanly — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgenizin dosya özelliklerinde görünen Başlık, Yazar, Konu ve Telif bilgilerini profesyonelce güncelleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const base64PdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Base64 to PDF",
    tagline: "Decode Base64 encoded strings into readable PDF files, or encode your PDF documents into Base64 strings for developer APIs — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yazılımcılar ve API entegrasyonları için Base64 kodlarını açılabilir PDF dosyasına dönüştürün veya tam tersini yapın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const invertPdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Turn bright white pages into high-contrast black backgrounds with white text. Protect your eyes while reading at night — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Parlak beyaz sayfaları yüksek kontrastlı siyah arka plana ve beyaz yazılara dönüştürün. Gece ders çalışırken gözlerinizi koruyun — ücretsiz, sınırsız ve tamamen gizli.",
...
export const markdownPdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Markdown to PDF",
    tagline: "Transform your Markdown notes, README files, and documentation into elegant, publication-ready PDF documents — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Markdown notlarınızı, GitHub README dosyalarınızı ve dökümantasyonlarınızı profesyonel mizanpaja sahip PDF belgelerine dönüştürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const htmlPdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "HTML to PDF",
    tagline: "Convert raw HTML code, web templates, invoices, and CSS styling into printable PDF documents in seconds — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "HTML ve CSS kodlarınızı, web sayfalarınızı ve fatura şablonlarınızı tek tıkla şık bir PDF belgesi haline getirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractPagesCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Select exact page numbers or ranges (e.g. 1-3, 7, 12) and extract them instantly into a brand new PDF document — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yüzlerce sayfalık belgenin içinden sadece ihtiyacınız olan 2-3 sayfayı cımbızla çeker gibi ayıklayıp tek dosyada toplayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const annotatePdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Annotate PDF",
    tagline: "Mark up documents with colorful highlighters, sticky notes, arrows, and freehand pens. Perfect for student notes and document reviews — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Ders kitaplarınıza ve makalelerinize renkli fosforlu kalemlerle notlar alın, oklar ve şekiller çizerek önemli yerleri işaretleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const editPdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Edit PDF",
    tagline: "Type new text, draw shapes, highlight sentences, and insert images onto any PDF document directly in your browser — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "PDF Düzenle",
    tagline: "Belgenizin üzerine tıklayıp istediğiniz yere yeni yazılar ekleyin, önemli cümleleri sarıyla vurgulayın ve şekiller çizin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const pdfFormsCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Fill PDF Forms",
    tagline: "Fill text fields, check boxes, select radio buttons, and complete fillable government, tax, or employment PDF forms — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Vize, iş başvurusu ve resmi vergi formlarını kutucuklara tıklayarak bilgisayarınızdan doldurun. Çıktı alıp elle yazmaya son — ücretsiz, sınırsız ve tamamen gizli.",
...
export const mixpdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    h1: "Mix PDF",
    tagline: "Combine odd and even page scans automatically. Interleave two separate PDF documents into a perfect sequential flow — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    h1: "Mix PDF",
    tagline: "Tek taraflı tarayıcılarla taranmış ön ve arka sayfaları tek tıkla 1, 2, 3, 4 sırasıyla harmanlayıp kusursuz tek dosya yapın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const splithalfpdfCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Cut two-page side-by-side book scans or double spreads down the middle into individual single pages — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Açık kitap taramalarındaki sol ve sağ sayfaları tam ortasından keserek her sayfayı ayrı birer yaprak haline getirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractbykeywordCopy = {
  en: {
    ...
    tagline: "Search a massive PDF for specific terms (e.g., 'Invoice', 'Confidential', 'Tax') and save only matching pages to a new PDF — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yüzlerce sayfalık arşivde aradığınız kelimenin geçtiği tüm sayfaları saniyeler içinde tespit edip tek bir PDF'te toplayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const splitbysizeCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Divide massive PDF documents into multiple smaller files that stay strictly under your specified MB limit (e.g. 10MB or 25MB) — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Büyük PDF belgelerini belirlediğiniz MB sınırının (örn: 10MB veya 25MB) altında kalacak şekilde otomatik olarak daha küçük dosyalara bölün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const addmarginsCopy = {
  en: {
    ...
    tagline: "Add extra white padding around your PDF pages. Perfect for ring binders, spiral binding, and booklet margins — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Sayfaların kenarlarına delgeç veya spiral ciltleme boşluğu bırakın. Yazıların ciltte kaybolmasını önleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const pdftosvgCopy = {
  en: {
    ...
    h1: "PDF to SVG",
    tagline: "Turn PDF diagrams, CAD drawings, and logos into scalable SVG vector graphics without losing any resolution — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "PDF logolarınızı, CAD çizimlerinizi ve grafiklerinizi kalitesi asla bozulmayan SVG vektör dosyalarına dönüştürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const removeAnnotationsCopy = {
  en: {
    ...
    tagline: "Erase all personal notes, teacher markings, review highlights, and drawing stamps to restore a pristine clean document — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Başkalarının aldığı notları, karalamaları, sarı vurguları ve yorumları tek tıkla temizleyip orijinal temiz haline döndürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const pdfToWebpCopy = {
  en: {
    ...
    h1: "PDF to WebP",
    tagline: "Convert PDF pages into next-generation WebP images. Enjoy superior compression and smaller file sizes for your website — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "PDF sayfalarınızı JPG'den %30 daha hafif olan yeni nesil WebP formatına çevirin. Web sitenizin açılış hızını artırın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const autoCropCopy = {
  en: {
    ...
    h1: "Auto-Crop PDF",
    tagline: "Detect empty whitespace around text and automatically crop every page to its exact content boundaries — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yazıların etrafındaki boş beyaz alanları yapay zeka ile otomatik algılayıp kırpın. Kindle ve tabletlerde tam ekran okuyun — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractTocCopy = {
  en: {
    ...
    tagline: "Export the structured bookmark outline, chapter hierarchy, and page references from any PDF into clean Markdown text — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Kitap ve tezlerdeki içindekiler ağacını, bölüm başlıklarını ve sayfa numaralarını tek tıkla düzenli Markdown metni olarak kaydedin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const overlayPdfCopy = {
  en: {
    ...
    tagline: "Superimpose your company letterhead, stationery template, or background stamp over your multi-page documents — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Şirket antetli kağıdınızı, kurumsal şablonunuzu veya arka plan logonuzu fatura ve raporlarınızın altına şablon olarak yerleştirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const changeBgCopy = {
  en: {
    ...
    tagline: "Tint page backgrounds with warm sepia, paper cream, or eye-friendly pastel colors for comfortable reading — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Parlak beyaz sayfaları sıcak sepya, kitap kağıdı kremi veya pastel tonlara boyayarak uzun okumalarda gözlerinizi koruyun — ücretsiz, sınırsız ve tamamen gizli.",
...
export const autoRedactCopy = {
  en: {
    ...
    h1: "Auto-Redact PDF",
    tagline: "Automatically detect sensitive PII (Social Security numbers, credit card numbers, email addresses) and black them out in one click — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "T.C. Kimlik Numarası, IBAN, kredi kartı ve e-posta gibi hassas KVKK verilerini tek tıkla otomatik bulup kalıcı karartın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const smartMarkdownCopy = {
  en: {
    ...
    tagline: "Structure headings, preserve data tables, and extract clean, readable Markdown syntax from complex PDF layouts — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Başlıkları (#, ##), listeleri ve tabloları akıllıca algılayarak PDF'lerinizi Notion, Obsidian ve LLM'ler için kusursuz Markdown'a çevirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const contrastEnhancerCopy = {
  en: {
    ...
    tagline: "Darken faint text and increase sharpness on old or low-quality document scans for crystal-clear readability — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Okunması zor olan silik fotokopileri ve soluk taranmış evrakları koyulaştırıp pırıl pırıl, net bir hale getirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const pdfToHtmlCopy = {
  en: {
    ...
    h1: "PDF to HTML",
    tagline: "Turn your PDF documents into responsive HTML web pages with clean CSS styling. Publish PDF content directly to the web — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "PDF dökümanlarınızı web sitenize doğrudan ekleyebileceğiniz temiz HTML ve CSS kodlarına dönüştürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractFontsCopy = {
  en: {
    ...
    tagline: "Identify font families used in any PDF document and extract embedded TrueType (TTF) and OpenType (OTF) font files — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Beğendiğiniz bir PDF tasarımında hangi fontların kullanıldığını anında tespit edin ve gömülü yazı tipi dosyalarını bilgisayarınıza indirin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const removeImagesCopy = {
  en: {
    ...
    tagline: "Purge all photos, banners, and bitmap graphics from your PDF documents to drastically reduce file size and save printing ink — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Ağır görselleri, reklamları ve fotoğrafları belgenizden temizleyin. Yalnızca yazıları bırakarak dosya boyutunu %90 düşürün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractUrlsCopy = {
  en: {
    ...
    tagline: "Extract all clickable hyperlinks, web references, and email addresses from your PDF documents in one organized list — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Makale, katalog ve raporların içindeki tüm web sitesi linklerini ve kaynak bağlantılarını tek tıkla toplu liste halinde çıkarın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const removeDuplicatesCopy = {
  en: {
    ...
    tagline: "Scan multi-page documents to automatically detect identical or repeated pages from accidental double scanning — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yanlışlıkla iki kere taranmış veya tekrarlayan aynı sayfaları otomatik analizle bulun ve belgenizden ayıklayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractAttachmentsCopy = {
  en: {
    ...
    tagline: "Unpack embedded files, invoices, XML schemas, and audio attachments packaged inside your PDF documents — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "PDF içerisine gömülmüş e-fatura XML dosyalarını, sözleşme eklerini ve sıkıştırılmış dosyaları kolayca ayıklayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractColorsCopy = {
  en: {
    ...
    tagline: "Analyze PDF artwork and brand guidelines to extract dominant HEX, RGB, and CMYK color palettes in seconds — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Katalog, logo ve broşürlerdeki baskı renklerini analiz edin. Tasarımcılar için birebir HEX ve RGB kodlarını anında kopyalayın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const removeTextCopy = {
  en: {
    ...
    tagline: "Erase all typography and text content while preserving embedded photos, illustrations, and background artwork — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgedeki tüm yazıları ve başlıkları temizleyin; mimari çizimleri, fotoğrafları ve grafik şablonlarını saf halde tutun — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractJavascriptCopy = {
  en: {
    ...
    tagline: "Inspect embedded Acrobat JavaScript code, action triggers, and form scripts to audit document security and safety — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "PDF içerisindeki gizli form betiklerini, otomatik açılış kodlarını ve güvenlik risklerini çalıştırmadan güvenle inceleyin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const splitBookmarksCopy = {
  en: {
    ...
    tagline: "Automatically carve books, manuals, and reports into separate PDF files for every major chapter bookmark — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yüzlerce sayfalık e-kitapları ve kullanım kılavuzlarını her bir ana bölüm başlığına (yer imine) göre otomatik ayrı dosyalara ayırın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const splitBlankCopy: Record<"en" | "tr", ToolCopy> = {
  en: {
    ...
    tagline: "Use blank divider sheets during batch scanning. Our tool automatically splits the batch into separate documents at every blank page — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Toplu evrak taramalarında araya koyduğunuz boş beyaz kağıtları ayraç olarak kullanın; sistem belgeleri otomatik ayrı dosyalara bölsün — ücretsiz, sınırsız ve tamamen gizli.",
...
export const viewerPrefsCopy = {
  en: {
    ...
    tagline: "Control how PDF readers display your document upon opening. Set default page layout, full-screen mode, and zoom level — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgenizin kullanıcılar tarafından açıldığında nasıl görüneceğini belirleyin. Tam ekran, çift sayfa kitap görünümü veya menü gizleme — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractHiddenTextCopy = {
  en: {
    ...
    tagline: "Detect invisible OCR layers, white-colored text on white backgrounds, and obscured content hidden in document streams — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Görsellerin arkasında gizlenen OCR yazılarını, saydam metinleri ve maskelenmiş gizli bilgileri tek tıkla tespit edin — ücretsiz, sınırsız ve tamamen gizli.",
...
export const wipeBookmarksCopy = {
  en: {
    ...
    tagline: "Cleanly remove the entire bookmark navigation tree and outline hierarchy from your PDF document in one click — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Belgenizin sol tarafında açılan gereksiz veya hatalı yer imi fihrist ağacını tek tıkla tamamen kaldırın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const extractTablesCopy = {
  en: {
    ...
    tagline: "Extract grid tables, financial statements, and invoice rows from PDF documents directly into clean CSV spreadsheets — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Fatura, bilanço ve fiyat listelerindeki tabloları tek tıkla Excel ve Google E-Tablolar'da düzenlenebilir CSV formatına aktarın — ücretsiz, sınırsız ve tamamen gizli.",
...
export const pdfToJsonCopy = {
  en: {
    ...
    h1: "PDF to JSON",
    tagline: "Parse PDF pages into structured JSON data trees. Extract text blocks, bounding boxes, font metadata, and document hierarchies — free, unlimited, and 100% private.",
  ...
  tr: {
    ...
    tagline: "Yazılımcılar ve yapay zeka (LLM/RAG) sistemleri için PDF belgelerini yapılandırılmış, temiz JSON veri ağacına dönüştürün — ücretsiz, sınırsız ve tamamen gizli.",
